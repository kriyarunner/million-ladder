      ...
      child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          Container(
            ...
            child: const Text('M',
                style: TextStyle(
                    fontSize: 18, fontWeight: FontWeight.w800, color: P.gold, height: 1)),
          ),
        ...
        Text(t.cardDomain,
            style: const TextStyle(
                fontSize: 16, fontWeight: FontWeight.w800, color: P.gold, letterSpacing: 0.3)),
        const SizedBox(height: 6),
        Text(t.cardTagline,
            style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: Colors.white, height: 1.3)),
